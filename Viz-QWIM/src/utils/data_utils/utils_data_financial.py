...
class Expected_Returns_Estimator_Type(Enum):
    ...
    **Shrinkage (Ledoit-Wolf style)**:
    ...
    Examples
    --------
    >>> from src.utils.data_utils.utils_data_financial import Expected_Returns_Estimator_Type
...
class Prior_Estimator_Type(Enum):
    ...
    **Entropy Pooling Objective**:
    ...
    Examples
    --------
    >>> from src.utils.data_utils.utils_data_financial import Prior_Estimator_Type
...
class Distribution_Estimator_Type(Enum):
    ...
    **Vine Copula Density** (R-vine example):
    ...
    Examples
    --------
    >>> from src.utils.data_utils.utils_data_financial import Distribution_Estimator_Type
