...
def _get_interest_rate_model_status(
    *, name_status: str) -> Interest_Rate_Model_Status:
    """Return a typed interest-rate status member from the dynamic ``aenum`` class."""
    return cast(Interest_Rate_Model_Status, getattr(Interest_Rate_Model_Status, name_status))


INTEREST_RATE_MODEL_STATUS_NOT_FITTED = _get_interest_rate_model_status(name_status = "NOT_FITTED")
INTEREST_RATE_MODEL_STATUS_FITTED = _get_interest_rate_model_status(name_status = "FITTED")
INTEREST_RATE_MODEL_STATUS_FAILED = _get_interest_rate_model_status(name_status = "FAILED")
...
class Interest_Rate_Model_Base(ABC):  # noqa: N801
    ...
    def __init__(self, name_model: str = "Interest Rate Model") -> None:
        """Initialize the interest-rate model with *name_model*."""
        ...
        self.m_status: Interest_Rate_Model_Status = INTEREST_RATE_MODEL_STATUS_NOT_FITTED
    ...
    def is_fitted(self) -> bool:
        ...
        return self.m_status == INTEREST_RATE_MODEL_STATUS_FITTED
    ...
    def __repr__(self) -> str:
        ...
        return f"Interest_Rate_Model_Base(name='{self.name_model}', status={self.m_status.value})"
