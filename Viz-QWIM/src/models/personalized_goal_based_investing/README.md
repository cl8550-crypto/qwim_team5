...
`personalized_goal_based_investing_Baseline` evaluates a single financial goal before
...
```python
from src.models.personalized_goal_based_investing import personalized_goal_based_investing_Baseline

goal = personalized_goal_based_investing_Baseline(
...
`scenario_tree_personalized_goal_based_investing.py` turns the cleaned daily data into
