...
from src.models.goal_based_investing.risk_portfolio_policy import normalize_risk_profile


if TYPE_CHECKING:
    from collections.abc import Mapping

    from src.models.goal_based_investing.risk_portfolio_policy import Predefined_Portfolio_Policy
