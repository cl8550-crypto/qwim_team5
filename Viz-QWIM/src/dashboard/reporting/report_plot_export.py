...
<    paths["goal_parity_weights"] = export_plot_goal_parity_weights(
    ...
    paths["covariance_condition_number"] = (
        export_plot_covariance_condition_number(
            reactives_shiny=reactives_shiny
        )
    )

    paths["personalized_goal_based_investing_allocation"] = (
        export_plot_personalized_goal_based_investing_allocation(
            reactives_shiny=reactives_shiny
        )
    )
    paths["personalized_goal_based_investing_goal_probabilities"] = (
        export_plot_personalized_goal_based_investing_goal_probabilities(
            reactives_shiny=reactives_shiny
        )
    )
    paths["personalized_goal_based_investing_wealth_distribution"] = (
        export_plot_personalized_goal_based_investing_wealth_distribution(
            reactives_shiny=reactives_shiny
        )
    )
