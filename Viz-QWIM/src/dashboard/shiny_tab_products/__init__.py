"""Products tab package for the QWIM Dashboard.

This package contains the Shiny module components for the Products tab,
including annuities, life insurance, and long-term-care subtabs.
"""
