...
from ._subtab_annuities_rila import _create_rila_ui_impl_QWIM
...
def _create_rila_ui() -> Any:
    ...
    return _create_rila_ui_impl_QWIM(
        payment_frequency_choices=_PAYMENT_FREQUENCY_CHOICES,
        protection_type_choices=_PROTECTION_TYPE_CHOICES,
        crediting_strategy_choices=_CREDITING_STRATEGY_CHOICES,
    )
...
@module.ui
def subtab_annuities_ui(  # pragma: no cover
...
@module.server
def subtab_annuities_server(  # pragma: no cover
    input: typing.Any,
    output: typing.Any,
    session: typing.Any,
    data_utils: dict[str, Any],
