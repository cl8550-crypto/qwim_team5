...
@module.ui
def tab_products_ui(  # pragma: no cover
    *, data_utils: dict[str, Any], data_inputs: dict[str, Any]) -> Any:
    ...
    tab_panels_products = [
        ui.nav_panel(
            "Annuities",
            subtab_annuities_ui(  # type: ignore[call-arg]
        ...
        ui.nav_panel(
            "Life Insurance",
            subtab_insurance_life_ui(  # type: ignore[call-arg]
        ...
        ui.nav_panel(
            "LTC Insurance",
            subtab_insurance_LTC_ui(  # type: ignore[call-arg]
...
@module.server
def tab_products_server(  # pragma: no cover
    input: typing.Any,
    output: typing.Any,
    session: typing.Any,
    data_utils: dict[str, Any],
    ...
    annuities_server_instance = subtab_annuities_server(  # type: ignore[call-arg]
        id="ID_tab_products_subtab_annuities",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
    ...
    insurance_life_server_instance = subtab_insurance_life_server(  # type: ignore[call-arg]
        id="ID_tab_products_subtab_insurance_life",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
        reactives_shiny=reactives_shiny,
    ...
    insurance_LTC_server_instance = subtab_insurance_LTC_server(  # type: ignore[call-arg]
        id="ID_tab_products_subtab_insurance_LTC",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
        reactives_shiny=reactives_shiny,
