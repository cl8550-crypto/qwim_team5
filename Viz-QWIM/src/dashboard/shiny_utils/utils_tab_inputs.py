...
def validate_module_inputs(
    *, data_utils: Any = None, data_inputs: Any = None, reactives_shiny: Any = None) -> Any:
...
def safe_get_input_value(
    *, input_object: Any, input_identifier: str, default_value: Any = None) -> Any:
...
def calculate_preset_date_range(
    *, time_period_selection: Any, max_date_available: Any, min_date_available: Any) -> Any:
