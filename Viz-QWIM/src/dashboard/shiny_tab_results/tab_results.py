...
@module.ui
def tab_results_ui(  # pragma: no cover
    *, data_utils: dict[str, Any], data_inputs: dict[str, Any]) -> Any:
    ...
    tab_panels_results = [
        ui.nav_panel(
            "Simulation",
            subtab_simulation_ui(  # type: ignore[call-arg]
        ...
        ui.nav_panel(
            "Reporting",
            subtab_reporting_ui(  # type: ignore[call-arg]
...
@module.server
def tab_results_server(  # pragma: no cover
    input: typing.Any,
    output: typing.Any,
    session: typing.Any,
    data_utils: dict[str, Any],
    ...
    reporting_server_instance = subtab_reporting_server(  # type: ignore[call-arg]
        id="ID_tab_results_subtab_reporting",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword, bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
    ...
    simulation_server_instance = subtab_simulation_server(  # type: ignore[call-arg]
        id="ID_tab_results_subtab_simulation",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword, bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
        reactives_shiny=reactives_shiny,
