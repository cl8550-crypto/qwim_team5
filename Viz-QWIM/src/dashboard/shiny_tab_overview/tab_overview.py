...
@module.server
def tab_overview_server(  # pragma: no cover
    input: typing.Any,
    output: typing.Any,
    session: typing.Any,
    ...
    executive_summary_server_instance = subtab_executive_summary_server(  # type: ignore[call-arg]
        id="ID_tab_overview_subtab_executive_summary",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword, bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
