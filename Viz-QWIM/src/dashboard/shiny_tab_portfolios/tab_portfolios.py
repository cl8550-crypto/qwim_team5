...
from .subtab_portfolios_optimalportfolios import (
...
@module.ui
def tab_portfolios_ui(*, data_utils: dict, data_inputs: dict) -> Any:  # pragma: no cover
    """
    ...
    tab_panels = [
        ui.nav_panel(
            "Portfolio Analysis",
            subtab_portfolios_analysis_ui(  # type: ignore[call-arg]
        ...
        ui.nav_panel(
            ...
            subtab_portfolios_comparison_ui(  # type: ignore[call-arg]
        ...
        ui.nav_panel(
            "Weights Analysis",
            subtab_weights_analysis_ui(  # type: ignore[call-arg]
        ...
        ui.nav_panel(
            ...
            subtab_portfolios_skfolio_ui(  # type: ignore[call-arg]
        ...
        ui.nav_panel(
            ...
            subtab_portfolios_optimalportfolios_ui(  # type: ignore[call-arg]
                id="ID_tab_portfolios_subtab_optimalportfolios",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
                data_utils=data_utils,
                data_inputs=data_inputs,
            ),
        ),
...
@module.server
def tab_portfolios_server(  # pragma: no cover
    input: typing.Any,
    output: typing.Any,
    session: typing.Any,
    data_utils: dict,
    ...
    subtab_portfolios_analysis_server_instance = subtab_portfolios_analysis_server(  # type: ignore[call-arg]
        id="ID_tab_portfolios_subtab_portfolios_analysis",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
    ...
    subtab_portfolios_comparison_server_instance = subtab_portfolios_comparison_server(  # type: ignore[call-arg]
        id="ID_tab_portfolios_subtab_portfolios_comparison",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
        reactives_shiny=reactives_shiny,
    ...
    subtab_weights_analysis_server_instance = subtab_weights_analysis_server(  # type: ignore[call-arg]
        id="ID_tab_portfolios_subtab_weights_analysis",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
        reactives_shiny=reactives_shiny,
    ...
    subtab_portfolios_skfolio_server_instance = subtab_portfolios_skfolio_server(  # type: ignore[call-arg]
        id="ID_tab_portfolios_subtab_skfolio",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
        reactives_shiny=reactives_shiny,
    ...
    # Initialize OptimalPortfolios Optimization server
    subtab_portfolios_optimalportfolios_server_instance = (
        subtab_portfolios_optimalportfolios_server(  # type: ignore[call-arg]
            id="ID_tab_portfolios_subtab_optimalportfolios",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
            data_utils=data_utils,
            data_inputs=data_inputs,
            reactives_shiny=reactives_shiny,
    ...
    return {
        ...
        "OptimalPortfolios_Optimization_Server": subtab_portfolios_optimalportfolios_server_instance,
    }
