...
from .subtab_outline import subtab_clients_outline_server, subtab_clients_outline_ui
...
@module.ui
def tab_clients_ui(data_utils: dict, data_inputs: dict) -> Any:  # pragma: no cover
    """
    ...
    tab_panels_clients = [
        ui.nav_panel(
            "Outline",
            subtab_clients_outline_ui(  # type: ignore[call-arg]
                id="ID_tab_clients_subtab_clients_outline",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        ...
        ui.nav_panel(
            "Personal Info",
            subtab_clients_personal_info_ui(  # type: ignore[call-arg]
        ...
        ui.nav_panel(
            "Assets",
            subtab_clients_assets_ui(  # type: ignore[call-arg]
        ...
        ui.nav_panel(
            "Goals",
            subtab_clients_goals_ui(  # type: ignore[call-arg]
        ...
        ui.nav_panel(
            "Income",
            subtab_clients_income_ui(  # type: ignore[call-arg]
        ...
        ui.nav_panel(
            "Summary",
            subtab_clients_summary_ui(  # type: ignore[call-arg]
...
@module.server
def tab_clients_server(  # pragma: no cover
    input: typing.Any,
    output: typing.Any,
    session: typing.Any,
    data_utils: dict,
    ...
    """
    # Initialize instance of clients outline server
    clients_outline_server_instance = subtab_clients_outline_server(  # type: ignore[call-arg]
        id="ID_tab_clients_subtab_clients_outline",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
    ...
    clients_personal_info_server_instance = subtab_clients_personal_info_server(  # type: ignore[call-arg]
        id="ID_tab_clients_subtab_clients_personal_info",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
        reactives_shiny=reactives_shiny,
    ...
    clients_assets_server_instance = subtab_clients_assets_server(  # type: ignore[call-arg]
        id="ID_tab_clients_subtab_clients_assets",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
        reactives_shiny=reactives_shiny,
    ...
    clients_goals_server_instance = subtab_clients_goals_server(  # type: ignore[call-arg]
        id="ID_tab_clients_subtab_clients_goals",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
        reactives_shiny=reactives_shiny,
    ...
    clients_income_server_instance = subtab_clients_income_server(  # type: ignore[call-arg]
        id="ID_tab_clients_subtab_clients_income",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
        reactives_shiny=reactives_shiny,
    ...
    clients_summary_server_instance = subtab_clients_summary_server(  # type: ignore[call-arg]
        id="ID_tab_clients_subtab_clients_summary",  # pyright: ignore[reportCallIssue]  # pyrefly: ignore[unexpected-keyword,bad-argument-count]
        data_utils=data_utils,
        data_inputs=data_inputs,
        reactives_shiny=reactives_shiny,
    ...
    # -----------------------------------------------------------------
    # Reactive observer: navigate to Personal Info after worksheet PDF accepted
    # -----------------------------------------------------------------
    @reactive.effect
    @reactive.event(reactives_shiny["Triggers_Shiny"]["Trigger_Populate_From_Worksheet"])
    def _navigate_after_worksheet_populate():
        """Navigate to Personal Info subtab after worksheet data is accepted.

        Actual input population is handled inside each subtab's server function
        (where ui.update_* calls are correctly scoped to the child module namespace).
        """
        ui.update_navset("ID_tab_clients_tabs_all", selected="Personal Info")
    ...
    return {
        "clients_Outline_Server": clients_outline_server_instance,
