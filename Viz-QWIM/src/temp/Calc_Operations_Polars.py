"""Experimental benchmarks for Polars weighted-sum and cumulative-product operations.

This module contains performance comparison functions for computing
weighted row sums and cumulative products on Polars DataFrames.  It
was used to evaluate alternative vectorised implementations before
integrating the fastest approach into the main data-processing pipeline.
