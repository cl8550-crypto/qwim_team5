...
class Insurance_Life_Whole(Insurance_Life_Base):
    ...
    **Simplified annual premium estimate** (level for life):
    ...
    def __init__(
        ...
        _logger.info(
            "Created Whole Life: face ${:,.2f}, guaranteed rate {:.2%}, participating: {}, "
            "premium-paying years: {}",
            face_amount,
            rate_guaranteed_interest,
            is_participating,
    ...
    def calc_internal_rate_of_return(
        ...
        projected_cv = self.calc_cash_value_at_year(year = num_years)
