...
class Test_Map_Distribution_Key_Golden:
    ...
    def test_lognormal_key_maps_to_lognormal_enum(self) -> None:
        ...
        result = _map_distribution_key(key = "lognormal")
    ...
    def test_student_t_key_maps_to_student_t_enum(self) -> None:
        ...
        result = _map_distribution_key(key = "student_t")
    ...
    def test_unknown_key_falls_back_to_normal(self) -> None:
        ...
        assert _map_distribution_key(key = "xyz") == Distribution_Type.NORMAL
        assert _map_distribution_key(key = "") == Distribution_Type.NORMAL
        assert _map_distribution_key(key = "NORMAL") == Distribution_Type.NORMAL  # case-sensitive
...
class Test_Create_Rng_Reproducibility:
    ...
    def test_same_seed_produces_identical_first_draw(self, rng_type: str) -> None:
        ...
        rng_a = _create_rng(rng_type = rng_type, seed=42)
        rng_b = _create_rng(rng_type = rng_type, seed=42)
    ...
    def test_different_seeds_produce_different_draws(self, rng_type: str) -> None:
        ...
        rng_a = _create_rng(rng_type = rng_type, seed=0)
        rng_b = _create_rng(rng_type = rng_type, seed=1)
    ...
    def test_unknown_rng_type_defaults_to_pcg64_behaviour(self) -> None:
        ...
        rng_default = _create_rng(rng_type = "unknown_generator", seed=42)
        rng_pcg64 = _create_rng(rng_type = "pcg64", seed=42)
...
class Test_Normalize_Data_Tab_Results_Golden:
    ...
    def test_none_method_returns_data_unchanged(
        ...
        result = normalize_data_tab_results(data_frame = simple_timeseries_df, method="none")
    ...
    def test_min_max_first_value_is_zero(self, simple_timeseries_df: pl.DataFrame) -> None:
        ...
        result = normalize_data_tab_results(data_frame = simple_timeseries_df, method="min_max")
    ...
    def test_z_score_mean_is_approximately_zero(
        ...
        result = normalize_data_tab_results(data_frame = simple_timeseries_df, method="z_score")
...
class Test_Transform_Data_Tab_Results_Golden:
    ...
    def test_none_transformation_returns_data_unchanged(
        ...
        result = transform_data_tab_results(data_frame = simple_timeseries_df, transformation="none")
        assert result["value"].to_list() == simple_timeseries_df["value"].to_list()
    ...
    def test_percent_change_adds_pct_column(
        ...
        result = transform_data_tab_results(
            data_frame = simple_timeseries_df, transformation="percent_change"
        )
    ...
    def test_cumulative_transform_adds_cum_column(
        ...
        result = transform_data_tab_results(data_frame = simple_timeseries_df, transformation="cumulative")
...
class Test_Process_Data_For_Plot_Tab_Results_Golden:
    ...
    def test_small_dataframe_returned_unchanged(
        ...
        result = process_data_for_plot_tab_results(
            data_frame = simple_timeseries_df, date_column="date", max_points=5000
        )
        assert result.shape == simple_timeseries_df.shape
    ...
    def test_large_dataframe_is_downsampled(self) -> None:
        ...
        result = process_data_for_plot_tab_results(data_frame = big_df, date_column="date", max_points=100)
