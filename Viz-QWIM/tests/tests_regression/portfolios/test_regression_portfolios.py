...
class Test_Regression_Benchmark_Values:
    ...
    def computed_benchmark(
        ...
        return create_benchmark_portfolio_values(portfolio_values = baseline_portfolio_values)
    ...
    def test_benchmark_reproducible(
        ...
        b1 = create_benchmark_portfolio_values(portfolio_values = baseline_portfolio_values)
        b2 = create_benchmark_portfolio_values(portfolio_values = baseline_portfolio_values)
...
class Test_Regression_Create_Custom_Portfolio:
    ...
    def test_creates_portfolio_without_date(self):
        ...
        result = create_custom_portfolio(components = ["VTI", "AGG", "BND"])
    ...
    def test_creates_portfolio_with_date(self):
        ...
        result = create_custom_portfolio(components = ["VTI", "AGG"], date="2024-03-15")
        assert isinstance(result, Portfolio_QWIM)
    ...
    def test_equal_weights_assigned(self):
        ...
        result = create_custom_portfolio(components = ["A", "B", "C", "D"])
    ...
    def test_raises_value_error_for_empty_components(self):
        ...
        with pytest.raises(Exception_Validation_Input):
            create_custom_portfolio(components = [])
    ...
    def test_num_components_matches_input_length(self, components):
        ...
        result = create_custom_portfolio(components = components[0])
