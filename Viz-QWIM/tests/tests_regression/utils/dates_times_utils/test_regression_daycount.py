...
class Test_Regression_Thirty_360:
    ...
    _calc = get_daycount_calculator(convention = Daycount_Convention.THIRTY_360)

    @pytest.mark.regression()
    def test_baseline_full_non_leap_year(self):
        """30/360: 2023-01-01 → 2024-01-01 = 360/360 = 1.0000000000."""
        result = self._calc.calc_year_fraction(date_start = DATE_2023_01_01, date_end = DATE_2024_01_01)
    ...
    def test_baseline_full_leap_year(self):
        ...
        result = self._calc.calc_year_fraction(date_start = DATE_2024_01_01, date_end = DATE_2025_01_01)
        assert result == pytest.approx(1.0, rel=1e-12)

    @pytest.mark.regression()
    def test_baseline_half_year_h1_2024(self):
        """30/360: 2024-01-01 → 2024-07-01 = 180/360 = 0.5000000000."""
        result = self._calc.calc_year_fraction(date_start = DATE_2024_01_01, date_end = DATE_2024_07_01)
    ...
    def test_baseline_half_year_h1_2023(self):
        ...
        result = self._calc.calc_year_fraction(date_start = DATE_2023_01_01, date_end = DATE_2023_07_01)
    ...
    def test_baseline_two_full_years(self):
        ...
        result = self._calc.calc_year_fraction(date_start = DATE_2023_01_01, date_end = DATE_2025_01_01)
        assert result == pytest.approx(2.0, rel=1e-12)

    @pytest.mark.regression()
    def test_baseline_one_month(self):
        """30/360: 2024-01-01 → 2024-02-01 = 30/360 = 0.083333..."""
        result = self._calc.calc_year_fraction(date_start = DATE_2024_01_01, date_end = date(2024, 2, 1))
        assert result == pytest.approx(30 / 360, rel=1e-12)

    @pytest.mark.regression()
    def test_baseline_quarter(self):
        """30/360: 2024-01-01 → 2024-04-01 = 90/360 = 0.25."""
        result = self._calc.calc_year_fraction(date_start = DATE_2024_01_01, date_end = date(2024, 4, 1))
    ...
    def test_baseline_end_of_month_capping(self):
        ...
        result = self._calc.calc_year_fraction(date_start = date(2024, 1, 31), date_end = date(2024, 3, 31))
...
class Test_Regression_Thirty_365:
    ...
    _calc = get_daycount_calculator(convention = Daycount_Convention.THIRTY_365)
    ...
    def test_baseline_numerator_same_as_30_360(self):
        ...
        calc_360 = get_daycount_calculator(convention = Daycount_Convention.THIRTY_360)
        r_365 = self._calc.calc_year_fraction(date_start = DATE_2024_01_01, date_end = DATE_2024_07_01)
        r_360 = calc_360.calc_year_fraction(date_start = DATE_2024_01_01, date_end = DATE_2024_07_01)
...
class Test_Regression_Actual_360:
    ...
    _calc = get_daycount_calculator(convention = Daycount_Convention.ACTUAL_360)
    ...
    def test_baseline_one_day(self):
        ...
        result = self._calc.calc_year_fraction(date_start = date(2024, 3, 15), date_end = date(2024, 3, 16))
    ...
    def test_baseline_90_days_2025(self):
        ...
        result = self._calc.calc_year_fraction(date_start = date(2025, 1, 1), date_end = date(2025, 4, 1))
...
class Test_Regression_Actual_365:
    ...
    _calc = get_daycount_calculator(convention = Daycount_Convention.ACTUAL_365)
    ...
    def test_baseline_one_day(self):
        ...
        result = self._calc.calc_year_fraction(date_start = date(2024, 6, 15), date_end = date(2024, 6, 16))
...
class Test_Regression_Actual_Actual:
    ...
    _calc = get_daycount_calculator(convention = Daycount_Convention.ACTUAL_ACTUAL)
    ...
    def test_baseline_cross_year_oct_2023_to_mar_2024(self):
        ...
        result = self._calc.calc_year_fraction(date_start = d_start, date_end = d_end)
        assert result == pytest.approx(expected, rel=1e-12)

    @pytest.mark.regression()
    def test_baseline_one_day_leap_year(self):
        """ACT/ACT: 2024-02-28 → 2024-02-29 = 1/366 = 0.002732240..."""
        result = self._calc.calc_year_fraction(date_start = DATE_2024_02_28, date_end = DATE_2024_02_29)
    ...
    def test_baseline_one_day_non_leap_year(self):
        ...
        result = self._calc.calc_year_fraction(date_start = date(2023, 3, 15), date_end = date(2023, 3, 16))
        assert result == pytest.approx(1 / 365, rel=1e-12)

    @pytest.mark.regression()
    def test_baseline_three_year_span_2022_to_2025(self):
        """ACT/ACT: 2022-01-01 → 2025-01-01 = 3.0 (2022+2023 non-leap, 2024 leap)."""
        result = self._calc.calc_year_fraction(date_start = date(2022, 1, 1), date_end = date(2025, 1, 1))
...
class Test_Regression_Cross_Convention_Ordering:
    ...
    def test_non_leap_year_ordering_locked(self):
        ...
        results = {
            conv: get_daycount_calculator(convention = conv).calc_year_fraction(
                date_start = DATE_2023_01_01, date_end = DATE_2024_01_01
            )
    ...
    def test_leap_year_ordering_locked(self):
        ...
        results = {
            conv: get_daycount_calculator(convention = conv).calc_year_fraction(
                date_start = DATE_2024_01_01, date_end = DATE_2025_01_01
            )
            for conv in Daycount_Convention
        }
        assert results[Daycount_Convention.THIRTY_365] == pytest.approx(360 / 365, rel=1e-9)
