...
class Class_Test_Regression_Constant_Default:
    ...
    def Test_Summary_Matches_Baseline(
        ...
        actual = fitted_constant_default.get_summary_statistics(df_predict = pred)
        _assert_dataframe_matches_baseline(actual, baseline, _TOL_DETERMINISTIC)
...
class Class_Test_Regression_Constant_Fitted:
    ...
    def Test_Summary_Matches_Baseline(
        ...
        actual = fitted_constant_historical.get_summary_statistics(df_predict = pred)
        _assert_dataframe_matches_baseline(actual, baseline, _TOL_DETERMINISTIC)
...
class Class_Test_Regression_Constant_Life_Expectancy:
    ...
    def Test_Life_Expectancy_Matches_Baseline(
        ...
        for idx_row in range(len(baseline)):
            ...
            actual_le = fitted_constant_default.get_life_expectancy(current_age = age)
    ...
    def Test_Life_Expectancy_Is_Age_Independent(
        ...
        le_0 = fitted_constant_default.get_life_expectancy(current_age = 0)
        le_65 = fitted_constant_default.get_life_expectancy(current_age = 65)
    ...
    def Test_Life_Expectancy_Analytical_Formula(
        ...
        actual_le = fitted_constant_default.get_life_expectancy(current_age = 0)
        assert actual_le == pytest.approx(expected_le, abs=_TOL_DETERMINISTIC)
...
class Class_Test_Regression_Constant_Survival:
    ...
    def Test_Survival_Matches_Baseline(
        ...
        for idx_row in range(len(baseline)):
            ...
            actual_prob = fitted_constant_default.survival_probability(current_age = age, t_years = t_yr)
    ...
    def Test_Survival_Analytical_Formula(
        ...
        for age in SURVIVAL_AGES:
            for t_yr in SURVIVAL_HORIZONS:
                ...
                actual = fitted_constant_default.survival_probability(current_age = age, t_years = t_yr)
    ...
    def Test_Survival_Is_Age_Independent(
        ...
        t_yr = 10.0
        prob_40 = fitted_constant_default.survival_probability(current_age = 40, t_years = t_yr)
        prob_80 = fitted_constant_default.survival_probability(current_age = 80, t_years = t_yr)
    ...
    def Test_Survival_Decreases_With_Horizon(
        ...
        age = 65
        probs = [
            fitted_constant_default.survival_probability(current_age = age, t_years = t_yr) for t_yr in SURVIVAL_HORIZONS
        ]
...
class Class_Test_Regression_Gompertz_Predictions:
    ...
    def Test_Summary_Matches_Baseline(
        ...
        actual = fitted_gompertz.get_summary_statistics(df_predict = pred)
        _assert_dataframe_matches_baseline(actual, baseline, _TOL_NUMERICAL)
...
class Class_Test_Regression_Gompertz_Life_Expectancy:
    ...
    def Test_Life_Expectancy_Matches_Baseline(
        ...
        for idx_row in range(len(baseline)):
            age = int(baseline["Age"][idx_row])
            expected_le = float(baseline["Life_Expectancy"][idx_row])
            actual_le = fitted_gompertz.get_life_expectancy(current_age = age)
    ...
    def Test_Life_Expectancy_Decreases_With_Age(
        ...
        le_values = [fitted_gompertz.get_life_expectancy(current_age = age) for age in LIFE_EXPECTANCY_AGES]
    ...
    def Test_Life_Expectancy_Is_Positive(
        ...
        for age in LIFE_EXPECTANCY_AGES:
            le_val = fitted_gompertz.get_life_expectancy(current_age = age)
    ...
    def Test_Life_Expectancy_At_65_Is_Reasonable(
        ...
        le_65 = fitted_gompertz.get_life_expectancy(current_age = 65)
...
class Class_Test_Regression_Gompertz_Survival:
    ...
    def Test_Survival_Matches_Baseline(
        ...
        for idx_row in range(len(baseline)):
            ...
            t_yr = float(baseline["t_years"][idx_row])
            expected_prob = float(baseline["Survival_Probability"][idx_row])
            actual_prob = fitted_gompertz.survival_probability(current_age = age, t_years = t_yr)
    ...
    def Test_Survival_Decreases_With_Horizon(
        ...
        age = 65
        probs = [fitted_gompertz.survival_probability(current_age = age, t_years = t_yr) for t_yr in SURVIVAL_HORIZONS]
        for idx_t in range(1, len(probs)):
            assert probs[idx_t] < probs[idx_t - 1], (
    ...
    def Test_Survival_Decreases_With_Age(
        ...
        t_yr = 10.0
        probs = [fitted_gompertz.survival_probability(current_age = age, t_years = t_yr) for age in SURVIVAL_AGES]
    ...
    def Test_Survival_Between_Zero_And_One(
        ...
        for age in SURVIVAL_AGES:
            for t_yr in SURVIVAL_HORIZONS:
                prob = fitted_gompertz.survival_probability(current_age = age, t_years = t_yr)
    ...
    def Test_Survival_Short_Horizon_Near_One(
        ...
        prob = fitted_gompertz.survival_probability(current_age = 40, t_years = 0.01)
        assert prob > 0.99
...
class Class_Test_Regression_Gompertz_Force_Of_Mortality:
    ...
    def Test_Force_Of_Mortality_Matches_Baseline(
        ...
        for idx_row in range(len(baseline)):
            ...
            actual_mu = fitted_gompertz.get_force_of_mortality(age = age)
    ...
    def Test_Force_Of_Mortality_Increases_With_Age(
        ...
        mu_values = [fitted_gompertz.get_force_of_mortality(age = age) for age in FORCE_OF_MORTALITY_AGES]
    ...
    def Test_Force_Of_Mortality_Is_Positive(
        ...
        for age in FORCE_OF_MORTALITY_AGES:
            mu_val = fitted_gompertz.get_force_of_mortality(age = age)
...
class Class_Test_Regression_Cross_Model_Consistency:
    ...
    def Test_Gompertz_Life_Expectancy_At_65_Differs_From_Constant(
        ...
        le_const = fitted_constant_default.get_life_expectancy(current_age = 65)
        le_gomp = fitted_gompertz.get_life_expectancy(current_age = 65)
    ...
    def Test_Survival_Ordering_At_High_Age(
        ...
        surv_const = fitted_constant_default.survival_probability(current_age = 80, t_years = 20.0)
        surv_gomp = fitted_gompertz.survival_probability(current_age = 80, t_years = 20.0)
