...
def _generate_3_asset_accessor_baselines(returns_df: pl.DataFrame) -> None:
    ...
    variances = {
        ...
        "Variance": [cov_obj.get_component_variance(component_name = name) for name in COMPONENT_NAMES_3],
    }
    ...
    for idx_i, name_i in enumerate(COMPONENT_NAMES_3):
        for idx_j in range(idx_i, len(COMPONENT_NAMES_3)):
            ...
            pairs_cov.append(cov_obj.get_component_covariance(component_name_1 = name_i, component_name_2 = name_j))
