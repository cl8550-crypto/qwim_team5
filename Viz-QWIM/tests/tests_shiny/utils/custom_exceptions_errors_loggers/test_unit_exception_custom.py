...
import src.utils.custom_exceptions_errors_loggers.exception_custom as exception_custom_module
...
pytestmark = [pytest.mark.unit, pytest.mark.shiny]
...
class Test_Global_Handlers:
    ...
    def test_install_restore_handlers(self, monkeypatch):
        """Test installing and restoring handlers."""
        orig_hook = sys.excepthook
        monkeypatch.setattr(exception_custom_module, "_ORIGINAL_EXCEPTHOOK", orig_hook)
