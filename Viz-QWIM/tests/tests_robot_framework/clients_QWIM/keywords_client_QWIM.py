...
def update_client_personal_info(
    ...
    return client.update_personal_info(data_personal_info = data)
...
def update_client_assets(
    ...
    return client.update_assets(data_assets = data)
...
def update_client_goals(
    ...
    return client.update_goals(data_goals = data)
...
def update_client_income(
    ...
    return client.update_income(data_income = data)
