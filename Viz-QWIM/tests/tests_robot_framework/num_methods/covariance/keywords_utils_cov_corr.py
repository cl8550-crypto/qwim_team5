...
def get_component_variance(
    ...
    """
    _require_imports()
    return float(cov_obj.get_component_variance(component_name = component_name))
...
def get_component_covariance(
    ...
    """
    _require_imports()
    return float(cov_obj.get_component_covariance(component_name_1 = component_name_1, component_name_2 = component_name_2))
