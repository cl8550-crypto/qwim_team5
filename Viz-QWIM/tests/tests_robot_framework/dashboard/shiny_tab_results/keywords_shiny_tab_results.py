...
class keywords_shiny_tab_results:
    ...
    @keyword("Module Source Should Contain Text")
    def module_source_should_contain_text(self, module_name: str, expected_text: str) -> None:
        """Assert that the module source contains a required text fragment.

        Args:
            module_name: Short module name.
            expected_text: Text fragment that must appear in the module source.
        """
