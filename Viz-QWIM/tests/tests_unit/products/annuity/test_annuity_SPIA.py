...
class Test_Annuity_SPIA_Validation:
    ...
    @pytest.mark.unit()
    def test_bool_guarantee_period_rejected(self) -> None:
        """Boolean guarantee periods should not be accepted as integers."""
    ...
    @pytest.mark.unit()
    def test_bool_joint_survivor_pct_rejected(self) -> None:
        """Boolean joint-survivor percentages should not be accepted as ratios."""
        with pytest.raises(Exception_Validation_Input):
            Annuity_SPIA(
                client_age=65,
                annuity_payout_rate=0.06,
                joint_survivor_pct=True,
            )
...
class Test_Annuity_SPIA_Payout_Calculations:
    ...
    def test_calc_annuity_payout_basic(self, spia_defaults: Annuity_SPIA) -> None:
        ...
        payout = spia_defaults.calc_annuity_payout(amount_principal = 100_000.0)
    ...
    def test_calc_annuity_payout_invalid_principal(
        ...
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_annuity_payout(amount_principal = 0.0)

        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_annuity_payout(amount_principal = -100.0)
    ...
    def test_calc_payout_in_year_first_year(
        ...
        payout = spia_defaults.calc_payout_in_year(amount_principal = 100_000.0, year_number = 1)
        assert payout == pytest.approx(6_000.0)
    ...
    def test_calc_payout_in_year_with_cola(
        ...
        payout = spia_with_cola.calc_payout_in_year(amount_principal = 100_000.0, year_number = 5)
    ...
    def test_calc_payout_in_year_invalid_year(
        ...
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_payout_in_year(amount_principal = 100_000.0, year_number = 0)

    @pytest.mark.unit()
    def test_calc_payout_in_year_invalid_principal(
        self,
        spia_defaults: Annuity_SPIA,
    ) -> None:
        """Non-positive principal should raise before year validation."""
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_payout_in_year(amount_principal = 0.0, year_number = 1)

    @pytest.mark.unit()
    def test_calc_monthly_payout(self, spia_defaults: Annuity_SPIA) -> None:
        """Monthly payout = annual / 12."""
        monthly = spia_defaults.calc_monthly_payout(amount_principal = 100_000.0)
...
class Test_Annuity_SPIA_Analytical_Calculations:
    ...
    def test_calc_present_value_invalid_inputs(
        ...
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_present_value_payments(amount_principal = 0.0, discount_rate = 0.04, life_expectancy_years = 20)
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_present_value_payments(amount_principal = 100_000.0, discount_rate = -0.01, life_expectancy_years = 20)
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_present_value_payments(amount_principal = 100_000.0, discount_rate = 0.04, life_expectancy_years = 0)
    ...
    def test_calc_breakeven_age(self, spia_defaults: Annuity_SPIA) -> None:
        ...
        breakeven_age = spia_defaults.calc_breakeven_age(amount_principal = 100_000.0)
    ...
    def test_calc_breakeven_age_with_cola(
        ...
        breakeven_age = spia_with_cola.calc_breakeven_age(amount_principal = 100_000.0)
        assert breakeven_age < 82
    ...
    def test_calc_breakeven_age_invalid_principal(
        ...
        """Non-positive principal should raise."""
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_breakeven_age(amount_principal = 0.0)
    ...
    def test_calc_breakeven_not_reached(self) -> None:
        ...
        with pytest.raises(Exception_Calculation):
            spia.calc_breakeven_age(amount_principal = 100_000.0)
    ...
    def test_calc_exclusion_ratio(self, spia_defaults: Annuity_SPIA) -> None:
        ...
        ratio = spia_defaults.calc_exclusion_ratio(amount_principal = 100_000.0, expected_payment_years = 20)
    ...
    def test_calc_exclusion_ratio_capped(self) -> None:
        ...
        ratio = spia.calc_exclusion_ratio(amount_principal = 100_000.0, expected_payment_years = 1)
        assert ratio == pytest.approx(1.0)

    @pytest.mark.unit()
    def test_calc_exclusion_ratio_zero_total_expected_returns_zero(
        self,
        spia_defaults: Annuity_SPIA,
    ) -> None:
        """A zero internal payout stream should return 0.0 defensively."""
        spia_defaults.m_annuity_payout_rate = 0.0
    ...
    def test_calc_exclusion_ratio_invalid_inputs(
        ...
        """Invalid inputs should raise."""
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_exclusion_ratio(amount_principal = 0.0, expected_payment_years = 20)
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_exclusion_ratio(amount_principal = 100_000.0, expected_payment_years = 0)

    @pytest.mark.unit()
    def test_calc_cumulative_payments(self, spia_defaults: Annuity_SPIA) -> None:
        """Cumulative payments over N years without COLA."""
        cumulative = spia_defaults.calc_cumulative_payments(amount_principal = 100_000.0, num_years = 10)
    ...
    def test_calc_cumulative_payments_with_cola(
        ...
        cumulative = spia_with_cola.calc_cumulative_payments(amount_principal = 100_000.0, num_years = 10)
    ...
    def test_calc_cumulative_payments_invalid_inputs(
        ...
        """Invalid inputs should raise."""
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_cumulative_payments(amount_principal = -100.0, num_years = 10)
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_cumulative_payments(amount_principal = 100_000.0, num_years = 0)
...
class Test_Annuity_SPIA_Withdrawal_Rates:
    ...
    def test_returns_withdrawal_rates_struct(
        ...
        result = spia_defaults.calc_withdrawal_rates(amount_principal = 100_000.0, desired_WR=0.04)
    ...
    def test_invalid_principal_zero_raises(
        ...
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_withdrawal_rates(amount_principal = 0.0, desired_WR=0.04)
    ...
    def test_invalid_principal_negative_raises(
        ...
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_withdrawal_rates(amount_principal = -1.0, desired_WR=0.04)
    ...
    def test_invalid_desired_wr_zero_raises(
        ...
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_withdrawal_rates(amount_principal = 100_000.0, desired_WR=0.0)
    ...
    def test_invalid_desired_wr_negative_raises(
        ...
        with pytest.raises(Exception_Validation_Input):
            spia_defaults.calc_withdrawal_rates(amount_principal = 100_000.0, desired_WR=-0.04)
