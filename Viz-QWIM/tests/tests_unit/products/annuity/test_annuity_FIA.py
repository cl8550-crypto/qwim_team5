...
class Test_Annuity_FIA_Validation:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param({"spread_rate": True}, id="bool_spread_rate"),
            pytest.param({"floor_rate": True}, id="bool_floor_rate"),
            pytest.param(
            ...
            pytest.param(
                {"rate_minimum_guarantee": True},
                id="bool_rate_minimum_guarantee",
            ),
            pytest.param(
                {"pct_minimum_guarantee_base": True},
                id="bool_pct_minimum_guarantee_base",
            ),
    ...
    def test_bool_numeric_constructor_fields_rejected(
        ...
        with pytest.raises(Exception_Validation_Input):
            Annuity_FIA(**constructor_kwargs)
    ...
    @pytest.mark.unit()
    def test_floor_rate_wrong_type(self) -> None:
        """Non-numeric floor rate should raise."""
        with pytest.raises(Exception_Validation_Input):
            Annuity_FIA(
                client_age=55,
                annuity_payout_rate=0.05,
                ...
                age_max_ratchet=85,
                rate_rollup_benefit=0.05,
                floor_rate="zero",  # type: ignore[arg-type]
            )
...
class Test_Annuity_FIA_Crediting_Calculations:
    ...
    def test_credited_rate_positive_index(
        ...
        credited = fia_defaults.calc_credited_rate(index_return = 0.10)
    ...
    def test_credited_rate_below_cap(self, fia_defaults: Annuity_FIA) -> None:
        ...
        credited = fia_defaults.calc_credited_rate(index_return = 0.03)
    ...
    def test_credited_rate_negative_index(
        ...
        credited = fia_defaults.calc_credited_rate(index_return = -0.20)
    ...
    def test_credited_rate_with_spread_and_participation(
        ...
        credited = fia_custom.calc_credited_rate(index_return = 0.10)
    ...
    def test_credited_rate_zero_index(self, fia_defaults: Annuity_FIA) -> None:
        ...
        credited = fia_defaults.calc_credited_rate(index_return = 0.0)
        assert credited == pytest.approx(0.0)
    ...
    def test_credited_rate_invalid_input(
        ...
        with pytest.raises(Exception_Validation_Input):
            fia_defaults.calc_credited_rate(index_return = "ten")  # type: ignore[arg-type]
...
class Test_Annuity_FIA_Account_Value:
    ...
    def test_account_value_single_period(
        ...
        values = fia_defaults.calc_account_value(amount_principal = 100_000.0, index_returns = [0.08])
        assert len(values) == 2
    ...
    def test_account_value_multiple_periods(
        ...
        values = fia_defaults.calc_account_value(amount_principal = 100_000.0, index_returns = returns)
        assert len(values) == 4
        assert values[0] == pytest.approx(100_000.0)
    ...
    def test_account_value_empty_returns(
        ...
        values = fia_defaults.calc_account_value(amount_principal = 100_000.0, index_returns = [])
        assert len(values) == 1
        assert values[0] == pytest.approx(100_000.0)
    ...
    def test_account_value_invalid_principal(
        ...
        with pytest.raises(Exception_Validation_Input):
            fia_defaults.calc_account_value(amount_principal = 0.0, index_returns = [0.05])
    ...
    def test_account_value_invalid_returns_type(
        ...
        with pytest.raises(Exception_Validation_Input):
            fia_defaults.calc_account_value(amount_principal = 100_000.0, index_returns = 0.05)  # type: ignore[arg-type]
...
class Test_Annuity_FIA_Benefit_Base:
    ...
    def test_calc_benefit_base_default_deferral(
        ...
        bb = fia_defaults.calc_benefit_base_with_rollup(amount_principal = 100_000.0)
    ...
    def test_calc_benefit_base_custom_years(
        ...
        bb = fia_defaults.calc_benefit_base_with_rollup(amount_principal = 100_000.0, years_deferred=5)
    ...
    def test_calc_benefit_base_zero_years(
        ...
        bb = fia_defaults.calc_benefit_base_with_rollup(amount_principal = 100_000.0, years_deferred=0)
    ...
    def test_calc_benefit_base_invalid_principal(
        ...
        """Non-positive principal should raise."""
        with pytest.raises(Exception_Validation_Input):
            fia_defaults.calc_benefit_base_with_rollup(amount_principal = 0.0)
    ...
    def test_calc_benefit_base_invalid_years(
        ...
        with pytest.raises(Exception_Validation_Input):
            fia_defaults.calc_benefit_base_with_rollup(amount_principal = 100_000.0, years_deferred=-1)
    ...
    def test_calc_minimum_guaranteed_value(
        ...
        mgv = fia_defaults.calc_minimum_guaranteed_value(amount_principal = 100_000.0, years = 10)
    ...
    def test_calc_minimum_guaranteed_value_year_zero(
        ...
        mgv = fia_defaults.calc_minimum_guaranteed_value(amount_principal = 100_000.0, years = 0)
    ...
    def test_calc_minimum_guaranteed_value_invalid_inputs(
        ...
        with pytest.raises(Exception_Validation_Input):
            fia_defaults.calc_minimum_guaranteed_value(amount_principal = 0.0, years = 10)
        with pytest.raises(Exception_Validation_Input):
            fia_defaults.calc_minimum_guaranteed_value(amount_principal = 100_000.0, years = -1)
...
class Test_Annuity_FIA_Surrender:
    ...
    def test_surrender_charge_year_zero(self, fia_defaults: Annuity_FIA) -> None:
        ...
        rate = fia_defaults.calc_surrender_charge_rate(year = 0)
    ...
    def test_surrender_charge_declining(self, fia_defaults: Annuity_FIA) -> None:
        ...
        rate = fia_defaults.calc_surrender_charge_rate(year = 3)
        expected = 0.08 * (1 - 3 / 7)
    ...
    def test_surrender_charge_after_schedule(
        ...
        rate = fia_defaults.calc_surrender_charge_rate(year = 7)
        assert rate == pytest.approx(0.0)
        rate = fia_defaults.calc_surrender_charge_rate(year = 10)
        assert rate == pytest.approx(0.0)
    ...
    def test_surrender_charge_negative_year(
        ...
        rate = fia_defaults.calc_surrender_charge_rate(year = -1)
        assert rate == pytest.approx(0.0)

    @pytest.mark.unit()
    def test_surrender_charge_zero_schedule_returns_zero(self) -> None:
        """A zero-year schedule disables surrender charges."""
        fia = Annuity_FIA(
            client_age=55,
            annuity_payout_rate=0.05,
            age_income_start=65,
            age_max_ratchet=85,
            rate_rollup_benefit=0.05,
            surrender_charge_schedule_years=0,
        )
        assert fia.calc_surrender_charge_rate(year = 0) == pytest.approx(0.0)

    @pytest.mark.unit()
    def test_surrender_value_year_zero(self, fia_defaults: Annuity_FIA) -> None:
        """Surrender value at year 0 with full charge."""
        sv = fia_defaults.calc_surrender_value(account_value = 100_000.0, year = 0)
    ...
    def test_surrender_value_after_schedule(
        ...
        sv = fia_defaults.calc_surrender_value(account_value = 100_000.0, year = 10)
    ...
    def test_surrender_value_invalid_account_value(
        ...
        with pytest.raises(Exception_Validation_Input):
            fia_defaults.calc_surrender_value(account_value = 0.0, year = 3)
...
class Test_Annuity_FIA_Payout_Calculations:
    ...
    def test_calc_annuity_payout_during_deferral(
        ...
        payout = fia_defaults.calc_annuity_payout(amount_principal = 100_000.0)
    ...
    def test_calc_annuity_payout_invalid_principal(
        ...
        """Non-positive principal should raise."""
        with pytest.raises(Exception_Validation_Input):
            fia_defaults.calc_annuity_payout(amount_principal = 0.0)

    @pytest.mark.unit()
    def test_calc_annuity_payout_at_income_start_without_scenarios(self) -> None:
        """At income start without scenarios, payout uses rollup path."""
        fia = Annuity_FIA(
            client_age=64,
            annuity_payout_rate=0.05,
            age_income_start=65,
        ...
        payout = fia.calc_annuity_payout(amount_principal = 100_000.0)

        assert payout == pytest.approx(5_000.0)
    ...
    def test_calc_monthly_payout_during_deferral(
        ...
        monthly = fia_defaults.calc_monthly_payout(amount_principal = 100_000.0)
...
class Test_Annuity_FIA_Inflation_Parameter:
    ...
    def test_calc_annuity_payout_accepts_none(
        ...
        payout = fia_defaults.calc_annuity_payout(amount_principal = 100_000.0, obj_inflation=None)
        assert payout == pytest.approx(0.0)
...
class Test_Annuity_FIA_Scenarios_Parameter:
    ...
    def test_calc_annuity_payout_with_scenarios_uses_ratchet_max(
        ...
        """At income start with ratchet active, payout uses max(rollup, account)."""
        fia = Annuity_FIA(
            client_age=64,
            annuity_payout_rate=0.05,
            age_income_start=65,
        ...
        payout = fia.calc_annuity_payout(
            amount_principal = 100_000.0,
            obj_scenarios=scenarios_df_fia,
        )

        assert payout == pytest.approx(110_250.0 * 0.05)
    ...
    def test_calc_annuity_payout_missing_date_column(
        ...
        with pytest.raises(Exception_Validation_Input):
            fia_past_income_age.calc_annuity_payout(amount_principal = 100_000.0, obj_scenarios=bad_df)
    ...
    def test_calc_annuity_payout_custom_index_column(
        ...
        with pytest.raises(Exception_Validation_Input):
            fia_past_income_age.calc_annuity_payout(amount_principal = 100_000.0, obj_scenarios=wrong_df)
...
class Test_Annuity_FIA_Withdrawal_Rates:
    ...
    def test_returns_withdrawal_rates_struct(
        ...
        result = fia_defaults.calc_withdrawal_rates(amount_principal = 100_000.0, desired_WR=0.04)
    ...
    def test_invalid_principal_zero_raises(
        ...
        with pytest.raises(Exception_Validation_Input):
            fia_defaults.calc_withdrawal_rates(amount_principal = 0.0, desired_WR=0.04)
    ...
    def test_invalid_principal_negative_raises(
        ...
        with pytest.raises(Exception_Validation_Input):
            fia_defaults.calc_withdrawal_rates(amount_principal = -1.0, desired_WR=0.04)
    ...
    def test_invalid_desired_wr_zero_raises(
        ...
        with pytest.raises(Exception_Validation_Input):
            fia_defaults.calc_withdrawal_rates(amount_principal = 100_000.0, desired_WR=0.0)
    ...
    def test_invalid_desired_wr_negative_raises(
        ...
        with pytest.raises(Exception_Validation_Input):
            fia_defaults.calc_withdrawal_rates(amount_principal = 100_000.0, desired_WR=-0.04)
