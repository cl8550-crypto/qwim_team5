...
class Test_Annuity_RILA_Validation:
    ...
    @pytest.mark.parametrize(
        ("invalid_kwargs",),
        [
            pytest.param({"term_years": True}, id="bool_term_years"),
            pytest.param({"buffer_rate": True}, id="bool_buffer_rate"),
            pytest.param({"floor_rate": False}, id="bool_floor_rate"),
            pytest.param({"cap_rate": True}, id="bool_cap_rate"),
            pytest.param({"participation_rate": True}, id="bool_participation_rate"),
            pytest.param(
                {"performance_trigger_rate": True},
                id="bool_performance_trigger_rate",
            ),
            pytest.param({"rate_rider_charge": True}, id="bool_rate_rider_charge"),
            pytest.param(
                {"rate_surrender_charge_initial": True},
                id="bool_rate_surrender_charge_initial",
            ),
            pytest.param(
                {"surrender_charge_schedule_years": True},
                id="bool_surrender_charge_schedule_years",
            ),
            pytest.param({"pct_free_withdrawal": True}, id="bool_pct_free_withdrawal"),
            pytest.param(
                {"rate_interim_discount": True},
                id="bool_rate_interim_discount",
            ),
            pytest.param({"payment_frequency": True}, id="bool_payment_frequency"),
        ],
    )
    def test_bool_numeric_constructor_fields_rejected(
        self,
        invalid_kwargs: dict[str, bool],
    ) -> None:
        """Boolean numeric constructor fields should not be silently accepted."""
        constructor_kwargs = {
            "client_age": 55,
            "annuity_payout_rate": 0.05,
            "age_income_start": 65,
        }
        constructor_kwargs.update(invalid_kwargs)

        with pytest.raises(Exception_Validation_Input):
            Annuity_RILA(**constructor_kwargs)
    ...
    @pytest.mark.unit()
    def test_invalid_financial_index_blank(self) -> None:
        """Reject blank financial_index values."""
        with pytest.raises(Exception_Validation_Input):
            Annuity_RILA(
                client_age=55,
                annuity_payout_rate=0.05,
...
class Test_Downside_Return:
    ...
    def test_buffer_positive_return(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        assert rila_buffer_cap.calc_downside_return(index_return = 0.10) == pytest.approx(0.0)

    @pytest.mark.unit()
    def test_buffer_zero_return(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Buffer: zero index return → downside = 0."""
        assert rila_buffer_cap.calc_downside_return(index_return = 0.0) == pytest.approx(0.0)
    ...
    def test_buffer_small_loss_within_buffer(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        assert rila_buffer_cap.calc_downside_return(index_return = -0.05) == pytest.approx(0.0)
    ...
    def test_buffer_loss_beyond_buffer(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        assert rila_buffer_cap.calc_downside_return(index_return = -0.25) == pytest.approx(-0.15)

    @pytest.mark.unit()
    def test_buffer_total_loss(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Buffer: total wipeout (-100%) → downside = -90%."""
        assert rila_buffer_cap.calc_downside_return(index_return = -1.0) == pytest.approx(-0.90)
    ...
    def test_floor_positive_return(self, rila_floor_cap: Annuity_RILA) -> None:
        ...
        assert rila_floor_cap.calc_downside_return(index_return = 0.10) == pytest.approx(0.0)
    ...
    def test_invalid_index_return_type(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_downside_return(index_return = "bad")  # type: ignore[arg-type]
...
class Test_Credited_Rate:
    ...
    def test_cap_floor_positive(self, rila_floor_cap: Annuity_RILA) -> None:
        ...
        assert rila_floor_cap.calc_credited_rate(index_return = 0.10) == pytest.approx(0.10)
    ...
    def test_cap_floor_loss_above_floor(self, rila_floor_cap: Annuity_RILA) -> None:
        ...
        assert rila_floor_cap.calc_credited_rate(index_return = -0.05) == pytest.approx(-0.05)

    @pytest.mark.unit()
    def test_cap_floor_loss_beyond_floor(self, rila_floor_cap: Annuity_RILA) -> None:
        """Cap + floor: loss beyond floor → clamped to floor."""
        assert rila_floor_cap.calc_credited_rate(index_return = -0.50) == pytest.approx(-0.10)
    ...
    def test_trigger_negative_beyond_buffer(self, rila_buffer_trigger: Annuity_RILA) -> None:
        ...
        assert rila_buffer_trigger.calc_credited_rate(index_return = -0.25) == pytest.approx(-0.10)
    ...
    def test_participation_positive_below_cap(
        ...
        # 10% * 1.5 = 15% < 25% cap
        assert rila_participation.calc_credited_rate(index_return = 0.10) == pytest.approx(0.15)
    ...
    def test_participation_positive_above_cap(
        ...
        # 20% * 1.5 = 30% > 25% cap → 25%
        assert rila_participation.calc_credited_rate(index_return = 0.20) == pytest.approx(0.25)
    ...
    def test_participation_negative(self, rila_participation: Annuity_RILA) -> None:
        ...
        # -5% with 10% buffer → 0
        assert rila_participation.calc_credited_rate(index_return = -0.05) == pytest.approx(0.0)
    ...
    def test_invalid_index_return_type(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Reject non-numeric index_return."""
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_credited_rate(index_return = "bad")  # type: ignore[arg-type]

    @pytest.mark.unit()
    def test_unknown_crediting_strategy_raises(
        self,
        rila_buffer_cap: Annuity_RILA,
    ) -> None:
        """Unexpected internal strategy values should raise calculation errors."""

        class UnknownCreditingStrategy:
            value = "Unknown"

        rila_buffer_cap.m_crediting_strategy = UnknownCreditingStrategy()

        with pytest.raises(Exception_Calculation, match="Unrecognised crediting strategy"):
            rila_buffer_cap.calc_credited_rate(index_return = 0.05)
...
class Test_Annualised_Credited_Rate:
    ...
    def test_annualised_positive(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_annualised_credited_rate(index_return = 0.20)
    ...
    def test_annualised_zero(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_annualised_credited_rate(index_return = 0.0)
    ...
    def test_annualised_negative(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_annualised_credited_rate(index_return = -0.30)
    ...
    def test_annualised_custom_term(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_annualised_credited_rate(index_return = 0.10, term_years=3)
    ...
    def test_annualised_invalid_term_years(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_annualised_credited_rate(index_return = 0.10, term_years=0)
...
class Test_Account_Value_At_Term_End:
    ...
    def test_positive_return(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_account_value_at_term_end(amount_principal = 100000, index_return = 0.10)
    ...
    def test_capped_return(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_account_value_at_term_end(amount_principal = 100000, index_return = 0.30)
    ...
    def test_loss_within_buffer(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_account_value_at_term_end(amount_principal = 100000, index_return = -0.05)
    ...
    def test_loss_beyond_buffer(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_account_value_at_term_end(amount_principal = 100000, index_return = -0.25)
    ...
    def test_invalid_principal(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_account_value_at_term_end(amount_principal = 0, index_return = 0.10)

        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_account_value_at_term_end(amount_principal = -1000, index_return = 0.10)
...
class Test_Interim_Value:
    ...
    def test_interim_at_term_start(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        # 100000 * (1 + 0) * 1/(1.02)^6
        result = rila_buffer_cap.calc_interim_value(amount_principal = 100000, current_index_return = 0.0, years_elapsed = 0)
    ...
    def test_interim_at_term_end(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_interim_value(amount_principal = 100000, current_index_return = 0.10, years_elapsed = 6)
    ...
    def test_interim_mid_term(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_interim_value(amount_principal = 100000, current_index_return = 0.08, years_elapsed = 3)
    ...
    def test_interim_with_loss(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_interim_value(amount_principal = 100000, current_index_return = -0.05, years_elapsed = 2)
    ...
    def test_interim_invalid_years_too_large(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_interim_value(amount_principal = 100000, current_index_return = 0.05, years_elapsed = 10)

    @pytest.mark.unit()
    def test_interim_invalid_negative_years(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Reject negative years_elapsed."""
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_interim_value(amount_principal = 100000, current_index_return = 0.05, years_elapsed = -1)

    @pytest.mark.unit()
    def test_interim_invalid_principal(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Reject non-positive principal."""
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_interim_value(amount_principal = 0, current_index_return = 0.05, years_elapsed = 2)
...
class Test_Account_Values_Multi_Term:
    ...
    def test_multi_term_positive_returns(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        values = rila_buffer_cap.calc_account_values_multi_term(amount_principal = 100000, term_index_returns = returns)
    ...
    def test_multi_term_with_rider_charge(self, rila_custom: Annuity_RILA) -> None:
        ...
        returns = [0.10]
        values = rila_custom.calc_account_values_multi_term(amount_principal = 100000, term_index_returns = returns)
    ...
    def test_multi_term_empty_returns(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        values = rila_buffer_cap.calc_account_values_multi_term(amount_principal = 100000, term_index_returns = [])
    ...
    def test_multi_term_invalid_principal(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Reject non-positive principal."""
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_account_values_multi_term(amount_principal = 0, term_index_returns = [0.10])

    @pytest.mark.unit()
    def test_multi_term_invalid_returns_type(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Reject non-list term_index_returns."""
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_account_values_multi_term(amount_principal = 100000, term_index_returns = 0.10)  # type: ignore[arg-type]
...
class Test_Surrender_Calculations:
    ...
    def test_surrender_charge_year_0(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        assert rila_buffer_cap.calc_surrender_charge_rate(year = 0) == pytest.approx(0.06)
    ...
    def test_surrender_charge_mid_schedule(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        assert rila_buffer_cap.calc_surrender_charge_rate(year = 3) == pytest.approx(0.03)

    @pytest.mark.unit()
    def test_surrender_charge_past_schedule(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Past schedule: zero charge."""
        assert rila_buffer_cap.calc_surrender_charge_rate(year = 6) == pytest.approx(0.0)
        assert rila_buffer_cap.calc_surrender_charge_rate(year = 10) == pytest.approx(0.0)

    @pytest.mark.unit()
    def test_surrender_charge_negative_year(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Negative year: returns 0 (graceful)."""
        assert rila_buffer_cap.calc_surrender_charge_rate(year = -1) == pytest.approx(0.0)

    @pytest.mark.unit()
    def test_surrender_charge_zero_schedule_returns_zero(
        self,
        rila_buffer_cap: Annuity_RILA,
    ) -> None:
        """A non-positive surrender schedule disables surrender charges."""
        rila_buffer_cap.m_surrender_charge_schedule_years = 0

        assert rila_buffer_cap.calc_surrender_charge_rate(year = 0) == pytest.approx(0.0)
    ...
    def test_surrender_value_year_0(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_surrender_value(account_value = 100000, year = 0)
    ...
    def test_surrender_value_past_schedule(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_surrender_value(account_value = 100000, year = 10)
        assert result == pytest.approx(100000.0)
    ...
    def test_surrender_value_invalid_account(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_surrender_value(account_value = 0, year = 3)
...
class Test_Death_Benefit:
    ...
    def test_rop_db_account_above_premium(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_death_benefit(amount_principal = 100000, account_value = 120000)
    ...
    def test_rop_db_account_below_premium(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_death_benefit(amount_principal = 100000, account_value = 80000)
        assert result == pytest.approx(100000.0)
    ...
    def test_no_death_benefit(self) -> None:
        ...
        result = rila.calc_death_benefit(amount_principal = 100000, account_value = 70000)
    ...
    def test_gmdb_account_below_premium(self, rila_custom: Annuity_RILA) -> None:
        ...
        result = rila_custom.calc_death_benefit(amount_principal = 100000, account_value = 50000)
        assert result == pytest.approx(100000.0)

    @pytest.mark.unit()
    def test_gmdb_without_rop_db_uses_guarantee(self) -> None:
        """GMDB alone should still guarantee principal on death."""
        rila = Annuity_RILA(
            client_age=55,
            annuity_payout_rate=0.05,
            age_income_start=65,
        ...
        result = rila.calc_death_benefit(amount_principal = 100000, account_value = 50000)
    ...
    def test_death_benefit_invalid_principal(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Reject non-positive principal."""
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_death_benefit(amount_principal = 0, account_value = 100000)
    ...
    def test_death_benefit_invalid_account_value(
        ...
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_death_benefit(amount_principal = 100000, account_value = -10000)
...
class Test_Payout_Calculations:
    ...
    def test_payout_during_deferral(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        assert rila_buffer_cap.calc_annuity_payout(amount_principal = 100000) == pytest.approx(0.0)
    ...
    def test_payout_active_no_scenarios(
        ...
        result = rila_past_income_age.calc_annuity_payout(amount_principal = 100000)
    ...
    def test_payout_active_scenarios_missing_date_column(
        ...
        with pytest.raises(Exception_Validation_Input):
            rila_past_income_age.calc_annuity_payout(amount_principal = 100000, obj_scenarios=bad_df)
    ...
    def test_monthly_payout_deferred(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        assert rila_buffer_cap.calc_monthly_payout(amount_principal = 100000) == pytest.approx(0.0)

    @pytest.mark.unit()
    def test_monthly_payout_active(self, rila_past_income_age: Annuity_RILA) -> None:
        """Monthly payout = annual payout / 12."""
        annual = rila_past_income_age.calc_annuity_payout(amount_principal = 100000)
        monthly = rila_past_income_age.calc_monthly_payout(amount_principal = 100000)
    ...
    def test_payout_invalid_principal(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Reject non-positive principal."""
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_annuity_payout(amount_principal = 0)

    @pytest.mark.unit()
    def test_payout_negative_principal(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Reject negative principal."""
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_annuity_payout(amount_principal = -100000)
...
class Test_Worst_Best_Case:
    ...
    def test_worst_case_buffer_single_term(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_worst_case_account_value(amount_principal = 100000, num_terms = 1)
    ...
    def test_worst_case_floor_single_term(self, rila_floor_cap: Annuity_RILA) -> None:
        ...
        result = rila_floor_cap.calc_worst_case_account_value(amount_principal = 100000, num_terms = 1)
    ...
    def test_worst_case_floor_multi_term(self, rila_floor_cap: Annuity_RILA) -> None:
        ...
        result = rila_floor_cap.calc_worst_case_account_value(amount_principal = 100000, num_terms = 3)
    ...
    def test_best_case_cap_single_term(self, rila_buffer_cap: Annuity_RILA) -> None:
        ...
        result = rila_buffer_cap.calc_best_case_account_value(amount_principal = 100000, num_terms = 1)
        assert result == pytest.approx(115000.0)

    @pytest.mark.unit()
    def test_best_case_cap_multi_term(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Best case (cap, 3 terms): compounded cap gains."""
        result = rila_buffer_cap.calc_best_case_account_value(amount_principal = 100000, num_terms = 3)
    ...
    def test_best_case_trigger(self, rila_buffer_trigger: Annuity_RILA) -> None:
        ...
        result = rila_buffer_trigger.calc_best_case_account_value(amount_principal = 100000, num_terms = 2)
    ...
    def test_best_case_participation(self, rila_participation: Annuity_RILA) -> None:
        ...
        result = rila_participation.calc_best_case_account_value(amount_principal = 100000, num_terms = 1)
    ...
    def test_worst_case_invalid_principal(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Reject non-positive principal."""
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_worst_case_account_value(amount_principal = 0)

    @pytest.mark.unit()
    def test_worst_case_invalid_num_terms(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Reject non-positive num_terms."""
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_worst_case_account_value(amount_principal = 100000, num_terms = 0)

    @pytest.mark.unit()
    def test_best_case_invalid_principal(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Reject non-positive principal."""
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_best_case_account_value(amount_principal = 0)

    @pytest.mark.unit()
    def test_best_case_invalid_num_terms(self, rila_buffer_cap: Annuity_RILA) -> None:
        """Reject non-positive num_terms."""
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_best_case_account_value(amount_principal = 100000, num_terms = -1)


@pytest.mark.unit()
class Test_Runtime_Bool_Input_Validation:
    """Test runtime RILA payout helpers reject boolean numeric inputs."""

    @pytest.mark.parametrize(
        ("method_name", "args", "kwargs", "expected_behavior"),
        [
            pytest.param("calc_surrender_charge_rate", (), {"year": True}, "zero", id="surrender_charge_year_bool"),
            pytest.param("calc_surrender_value", (), {"account_value": True, "year": 0}, "raises", id="surrender_value_account_bool"),
            pytest.param("calc_death_benefit", (), {"amount_principal": True, "account_value": 100000.0}, "raises", id="death_benefit_principal_bool"),
            pytest.param("calc_death_benefit", (), {"amount_principal": 100000.0, "account_value": True}, "raises", id="death_benefit_account_bool"),
            pytest.param("calc_annuity_payout", (), {"amount_principal": True}, "raises", id="annuity_payout_principal_bool"),
            pytest.param("calc_withdrawal_rates", (), {"amount_principal": True, "desired_WR": 0.04}, "raises", id="withdrawal_rates_principal_bool"),
            pytest.param("calc_withdrawal_rates", (), {"amount_principal": 100000.0, "desired_WR": True}, "raises", id="withdrawal_rates_desired_wr_bool"),
            pytest.param("calc_worst_case_account_value", (), {"amount_principal": True}, "raises", id="worst_case_principal_bool"),
            pytest.param("calc_worst_case_account_value", (), {"amount_principal": 100000.0, "num_terms": True}, "raises", id="worst_case_num_terms_bool"),
            pytest.param("calc_best_case_account_value", (), {"amount_principal": True}, "raises", id="best_case_principal_bool"),
            pytest.param("calc_best_case_account_value", (), {"amount_principal": 100000.0, "num_terms": True}, "raises", id="best_case_num_terms_bool"),
        ],
    )
    def test_runtime_bool_numeric_inputs(
        self,
        rila_buffer_cap: Annuity_RILA,
        method_name: str,
        args: tuple[object, ...],
        ...
        """Boolean runtime inputs should not be coerced through RILA payout helpers."""
        method = getattr(rila_buffer_cap, method_name)

        if expected_behavior == "zero":
            assert method(*args, **kwargs) == pytest.approx(0.0)
            return
...
class Test_String_Representation:
    ...
    @pytest.mark.unit()
    def test_string_unknown_crediting_strategy_falls_through(
        self,
        rila_buffer_cap: Annuity_RILA,
    ) -> None:
        """Unexpected internal strategy values should still render a string."""
        ...
        assert "Crediting: Unknown" in result
...
class Test_Parametrised_Edge_Cases:
    ...
    def test_credited_rate_boundary_values(
        ...
        result = rila_buffer_cap.calc_credited_rate(index_return = index_return)
    ...
    def test_surrender_charge_schedule(
        ...
        result = rila_buffer_cap.calc_surrender_charge_rate(year = year)
...
class Test_Annuity_RILA_Inflation_Parameter:
    ...
    def test_calc_annuity_payout_accepts_none(
        ...
        payout = rila_buffer_cap.calc_annuity_payout(amount_principal = 100_000.0, obj_inflation=None)
...
class Test_Annuity_RILA_Withdrawal_Rates:
    ...
    def test_returns_withdrawal_rates_struct(
        ...
        result = rila_buffer_cap.calc_withdrawal_rates(amount_principal = 100_000.0, desired_WR=0.04)
    ...
    def test_nominal_wr_positive_past_income_age(
        ...
        result = rila_past_income_age.calc_withdrawal_rates(amount_principal = 100_000.0, desired_WR=0.04)
        assert result.nominal_WR > 0.0

    @pytest.mark.unit()
    def test_default_desired_wr_uses_payout_rate(
        self,
        rila_past_income_age: Annuity_RILA,
    ) -> None:
        """Omitted desired_WR falls back to the contract payout rate."""
        result = rila_past_income_age.calc_withdrawal_rates(amount_principal = 100_000.0)
        assert result.nominal_WR == pytest.approx(rila_past_income_age.m_annuity_payout_rate)
        assert result.real_WR == pytest.approx(rila_past_income_age.m_annuity_payout_rate)
    ...
    def test_invalid_principal_zero_raises(
        ...
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_withdrawal_rates(amount_principal = 0.0, desired_WR=0.04)
    ...
    def test_invalid_principal_negative_raises(
        ...
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_withdrawal_rates(amount_principal = -1.0, desired_WR=0.04)
    ...
    def test_invalid_desired_wr_zero_raises(
        ...
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_withdrawal_rates(amount_principal = 100_000.0, desired_WR=0.0)
    ...
    def test_invalid_desired_wr_negative_raises(
        ...
        with pytest.raises(Exception_Validation_Input):
            rila_buffer_cap.calc_withdrawal_rates(amount_principal = 100_000.0, desired_WR=-0.04)
