...
@pytest.mark.unit()
class Class_Test_Pkg_Azapy_Returns_Data_Content_Validation:
    """Focused tests for azapy returns-data content validation boundaries."""

    @pytest.mark.unit()
    def Test_Null_Date_Value_Is_Rejected(self) -> None:
        """A null Date value should fail azapy returns-data validation."""
    ...
    def Test_Null_Asset_Value_Is_Rejected(self) -> None:
        """A null asset-return value should fail azapy returns-data validation."""
    ...
    def Test_Non_Finite_Asset_Value_Is_Rejected(
        ...
        """A non-finite asset-return value should fail azapy returns-data validation."""
