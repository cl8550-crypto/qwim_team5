...
def step_update_personal_info(
    ...
    context.update_result = context.client.update_personal_info(data_personal_info = data)
...
def step_personal_info_update_true(context) -> None:
    """Step personal info update true."""
...
def step_retirement_age_gt_current_age(context) -> None:
    """Step retirement age gt current age."""
...
def step_personal_info_df_not_empty(context) -> None:
    """Step personal info df not empty."""
    _require_imports()
...
def step_update_assets(context, retirement: float, stocks: float) -> None:
    ...
    context.update_result = context.client.update_assets(data_assets = data)
...
def step_update_goals(context, amount: float, year: int) -> None:
    ...
    context.update_result = context.client.update_goals(data_goals = data)
...
def step_update_income(context, salary: float, social_security: float) -> None:
    ...
    context.update_result = context.client.update_income(data_income = data)
