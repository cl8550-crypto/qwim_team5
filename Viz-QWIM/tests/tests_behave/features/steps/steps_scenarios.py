...
def step_component_series_length(context, count: int) -> None:
    ...
    series = context.scenarios_obj.get_component_series(component_name = first_comp)
...
def step_filter_reduces_rows(context) -> None:
    ...
    filtered = context.scenarios_obj.filter_by_date_range(start_date = start, end_date = mid)
