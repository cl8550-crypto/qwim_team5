...
def step_portfolio_has_n_components(context, n: int) -> None:
    """Step portfolio has n components."""
...
def step_two_portfolios_identical_weights(context) -> None:
    """Step two portfolios identical weights."""
