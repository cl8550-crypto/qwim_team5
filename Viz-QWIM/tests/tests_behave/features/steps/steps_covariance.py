...
def step_variance_accessor_aapl(context) -> None:
    ...
    actual = context.cov_matrix_obj.get_component_variance(component_name = "AAPL")
...
def step_covariance_accessor_aapl_msft(context) -> None:
    ...
    actual = context.cov_matrix_obj.get_component_covariance(component_name_1 = "AAPL", component_name_2 = "MSFT")
    assert abs(actual - expected) < 1e-12, (
