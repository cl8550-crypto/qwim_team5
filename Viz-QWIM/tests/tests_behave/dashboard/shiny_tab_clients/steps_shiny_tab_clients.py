...
def step_validate_age(context: Any, age: int) -> None:
    ...
    try:
        context.age_validation_result = context.utils.validate_age_range(age_value = age, min_age=18, max_age=100)
...
def step_validate_financial_amount(context: Any, amount: str) -> None:
    ...
    numeric = float(amount)
    try:
        context.financial_validation_result = context.utils.validate_financial_amount(amount_value = numeric)
