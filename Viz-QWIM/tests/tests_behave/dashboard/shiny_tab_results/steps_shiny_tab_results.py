...
def step_module_source_contains_text(
    context: Any,
    module_name: str,
    expected_text: str,
) -> None:
    """Assert that a Results-tab source file contains a specific text fragment."""
    source = _read_source(f"src.dashboard.shiny_tab_results.{module_name}")
