...
class Test_Client_Construction_Integration:
    ...
    def test_client_has_non_empty_id_after_construction(
        ...
        assert primary_client.client_ID == "TEST_CLI_001", (
...
class Test_Client_Update_Assets_Integration:
    ...
    def test_update_assets_returns_true(
        ...
        result = primary_client.update_assets(data_assets = sample_assets)
    ...
    def test_update_assets_populates_dataframe(
        ...
        primary_client.update_assets(data_assets = sample_assets)
        assets_df = primary_client.m_assets
    ...
    def test_update_assets_with_empty_list_resets_to_empty_dataframe(
        ...
        result = primary_client.update_assets(data_assets = [])
...
class Test_Client_Update_Goals_Integration:
    ...
    def test_update_goals_returns_true(
        ...
        result = primary_client.update_goals(data_goals = sample_goals)
    ...
    def test_update_goals_populates_dataframe(
        ...
        primary_client.update_goals(data_goals = sample_goals)
...
class Test_Client_Update_Personal_Info_Integration:
    ...
    def test_update_personal_info_returns_true(
        ...
        result = primary_client.update_personal_info(data_personal_info = sample_personal_info)
    ...
    def test_update_personal_info_first_name_stored(
        ...
        primary_client.update_personal_info(data_personal_info = sample_personal_info)

        assert primary_client.first_name == "Jane", (
            f"First Name must be 'Jane', got '{primary_client.first_name}'"
        )
    ...
    def test_update_personal_info_last_name_stored(
        ...
        assert primary_client.last_name == "Doe", (
            f"Last Name must be 'Doe', got '{primary_client.last_name}'"
        )
...
class Test_Financial_Validation_And_Formatting_Integration:
    ...
    def test_validate_then_format_pipeline(
        ...
        display = format_currency_display(amount_value = validated)
    ...
    def test_validate_financial_amount_rejects_negative(self) -> None:
        ...
        with pytest.raises(Exception_Validation_Input):
            validate_financial_amount(amount_value = -1.0)
    ...
    def test_validate_age_range_returns_integer(self) -> None:
        ...
        result = validate_age_range(age_value = 45, minimum_age = 18, maximum_age = 100, age_type_description = "Test age")
    ...
    def test_validate_age_range_raises_for_out_of_range(self) -> None:
        ...
        with pytest.raises((ValueError, Exception)):
            validate_age_range(age_value = 17, minimum_age = 18, maximum_age = 100, age_type_description = "Test age under minimum")
    ...
    def test_validate_string_input_strips_whitespace(self) -> None:
        ...
        result = validate_string_input(input_value = "  Jane Doe  ", field_description = "test field")
...
class Test_Client_Lifecycle_Integration:
    ...
    def test_full_client_population_pipeline(
        ...
        result_personal = primary_client.update_personal_info(data_personal_info = sample_personal_info)
        result_assets = primary_client.update_assets(data_assets = sample_assets)
        result_goals = primary_client.update_goals(data_goals = sample_goals)
        result_income = primary_client.update_income(data_income = sample_income)
        ...
        assert primary_client.first_name == "Jane", "First name must be Jane"
    ...
    def test_successive_update_assets_replaces_data(
        ...
        primary_client.update_assets(data_assets = second_assets)
