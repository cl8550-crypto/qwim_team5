...
class Test_Process_Data_For_Plot_Integration:
    ...
    def test_small_df_returned_unchanged(self, small_df: pl.DataFrame) -> None:
        ...
        result = process_data_for_plot_tab_results(data_frame = small_df, date_column="date", max_points=5000)
    ...
    def test_large_df_downsampled_below_max_points(self, large_df: pl.DataFrame) -> None:
        ...
        max_points = 50
        result = process_data_for_plot_tab_results(data_frame = large_df, date_column="date", max_points=max_points)
    ...
    def test_none_input_returns_none(self) -> None:
        ...
        result = process_data_for_plot_tab_results(data_frame = None, date_column="date")
    ...
    def test_output_preserves_all_columns(self, small_df: pl.DataFrame) -> None:
        ...
        result = process_data_for_plot_tab_results(data_frame = small_df, date_column="date")
...
class Test_Normalize_Data_Tab_Results_Integration:
    ...
    def test_min_max_normalisation_range_is_zero_to_one(
        ...
        result = normalize_data_tab_results(data_frame = small_df, method="min_max")
    ...
    def test_z_score_normalisation_mean_is_near_zero(
        ...
        result = normalize_data_tab_results(data_frame = small_df, method="z_score")
    ...
    def test_none_method_returns_dataframe_unchanged(
        ...
        result = normalize_data_tab_results(data_frame = small_df, method="none")
...
class Test_Transform_Data_Tab_Results_Integration:
    ...
    def test_percent_change_first_value_is_zero(
        ...
        result = transform_data_tab_results(data_frame = small_df, transformation="percent_change")
    ...
    def test_cumulative_creates_new_columns(
        ...
        result = transform_data_tab_results(data_frame = small_df, transformation="cumulative")
    ...
    def test_none_transformation_returns_unchanged(
        ...
        result = transform_data_tab_results(data_frame = small_df, transformation="none")
...
class Test_Chained_Results_Processing_Integration:
    ...
    def test_process_then_normalize_min_max(
        ...
        processed = process_data_for_plot_tab_results(data_frame = small_df, date_column="date", max_points=5000)
        normalised = normalize_data_tab_results(data_frame = processed, method="min_max")
    ...
    def test_normalize_min_max_then_percent_change(
        ...
        normalised = normalize_data_tab_results(data_frame = df_rising_from_dip, method="min_max")
        transformed = transform_data_tab_results(data_frame = normalised, transformation="percent_change")
    ...
    def test_full_three_stage_chain(self, large_df: pl.DataFrame) -> None:
        ...
        processed = process_data_for_plot_tab_results(data_frame = large_df, date_column="date", max_points=100)
        normalised = normalize_data_tab_results(data_frame = processed, method="z_score")
        transformed = transform_data_tab_results(data_frame = normalised, transformation="cumulative")
    ...
    def test_chain_with_none_passthrough_methods(
        ...
        processed = process_data_for_plot_tab_results(data_frame = small_df, date_column="date", max_points=5000)
        normalised = normalize_data_tab_results(data_frame = processed, method="none")
        transformed = transform_data_tab_results(data_frame = normalised, transformation="none")
